  ...
  return (
    ...
    <>
      ...
      <div className="flex justify-between gap-0 px-2 items-center text-[14px] sm:text-sm  mb-4 border-gray-200 border rounded-lg">
        ...
        {category.length !== 0 && (
          <select
            className="h-8 bg-white text-gray-700 border-r outline-none"
      ...
      {products.length > 0 && (
     <div className="border-l-[1px] border-r-[1px] border-b-[1px] border-gray-300 rounded-md shadow-md bottom-8 relative">
