      ...
      {message && (
        <motion.div
          ...
          className="fixed top-6 md:top-14 left-0 md:left-[50%] transform md:-translate-x-1/2 z-50 
             bg-[#ca1515] text-white py-3 md:py-4 px-4 md:px-6 rounded-lg 
             shadow-lg flex items-center justify-between gap-3 
             w-full md:w-auto max-w-full md:max-w-fit mx-4 md:mx-0"
        >
          <div className="flex items-center gap-2">
            <div className='w-5 h-5 md:w-10 md:h-7 border-white border rounded-full text-white text-center flex justify-center items-center'>
              <Check size={20} />
            </div> 
